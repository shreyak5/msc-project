...
# batches - matches dataset_processing/dataloading/datasets.py's MICA_CATEGORIES.
...
def main():
    ...
    entries = [e for e in load_datasets_yaml(args.datasets_yaml) if e.category in MICA_CATEGORIES]
    if args.dataset != "all":
