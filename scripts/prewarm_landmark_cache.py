...
from dataset_processing.dataloading.landmark_cache import get_landmarks  # noqa: E402
                ...
                for frame_index in frame_indices:
                    ...
                    try:
                        result = get_landmarks(
                            cfg.landmark_cache_root, entry.name, row.sample_id, frame_index,
                        ...
                        # get_landmarks has no on_noface callback (unlike get_mica_shape) -
                        # a missing face is only visible via its returned flags, so log it
                        # here rather than inside the cache function itself.
                        ...
                        # Defense-in-depth for anything unexpected that get_landmarks' own
