...
#SBATCH --job-name=eval_csl_daily_emica
#SBATCH --output=/home/u6ga/sk3925.u6ga/sk3925_project/msc-project/slurm_jobs/output/eval_csl_daily_emica_%j.out
#SBATCH --nodes=1
#SBATCH --gpus=4
...
# single-node 4-GPU pattern eval_csl_daily.sh already uses for smirk/ours_no_temporal, no
# multi-node complexity needed (unlike slurm_jobs/method_evals/eval_csl_daily_pixel3dmm.sh).
#
...
NUM_SHARDS=4
OUTPUT_DIR=evaluation/output_dataset_emica/csl_daily
