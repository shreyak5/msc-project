...
#SBATCH --job-name=eval_csl_daily_ours_kernel_smooth
#SBATCH --output=/home/u6ga/sk3925.u6ga/sk3925_project/msc-project/slurm_jobs/output/eval_csl_daily_ours_kernel_smooth_%j.out
#SBATCH --nodes=1
#SBATCH --gpus=4
...
for combo_idx in "${!SIGMAS[@]}"; do
  ...
  OUTPUT_DIR=evaluation/output_dataset_ours_kernel_smooth/csl_daily/r${RADIUS}_sigma${SIGMA}_T${TEMPERATURE}
