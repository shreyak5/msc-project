...
#SBATCH --job-name=eval_how2sign_ours_noTT
#SBATCH --output=/home/u6ga/sk3925.u6ga/sk3925_project/msc-project/slurm_jobs/output/eval_how2sign_ours_noTT_%j.out
#SBATCH --nodes=1
#SBATCH --gpus=4
# Bumped from 10h: evaluate_clip now writes to the crop/GT-landmark caches
...
NUM_SHARDS=4
OUTPUT_DIR=evaluation/output_dataset_ours_noTT/how2sign
