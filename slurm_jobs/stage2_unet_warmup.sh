...
#SBATCH --job-name=stage2_unet_warmup
#SBATCH --output=/home/u6ga/sk3925.u6ga/sk3925_project/msc-project/slurm_jobs/output/stage2_unet_warmup_%j.out
#SBATCH --nodes=4
#SBATCH --ntasks=4
...
CONFIG=training/config/stage2_unet_warmup.yaml
GPUS_PER_NODE=4
MASTER_PORT=29500
